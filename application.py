...
if __name__ == "__main__":
    config = uvicorn.Config("application:app", host="http://fastapi-ebs-githubactions-env.eba-nsg3p8d8.eu-central-1.elasticbeanstalk.com/", port=443, port=80, log_level="info")
